    ...
    return (
      <div>
       ...
       <div className="mt-10 flex items-center justify-right gap-x-6">
          <Link to="/quizzes" className="rounded-md bg-custom-black px-3.5 py-2.5 text-lg font-semibold text-white shadow-lg hover:bg-custom-red focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Get started</Link>
