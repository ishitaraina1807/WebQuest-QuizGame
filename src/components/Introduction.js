    ...
    return (
      <div>
       ...
       <div className="mt-10 flex items-center justify-right gap-x-6">
          <a href="#" className="rounded-md bg-custom-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:text-custom-green focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
